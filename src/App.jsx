...
const hifiPrototypes = [
  ...
  { idea: "Dark Horse", ideaColor: "bg-fuchsia-50 text-fuchsia-700 border-fuchsia-200", accentColor: "from-fuchsia-500 to-purple-500", title: "Stress Monitoring Band", question: "How can we work off of current stress relief devices?", description: "Working off the heart rate monitoring capabilities of Apple Watches and similar wearables, we designed a cuff that fits around the arm and acts as a dedicated stress monitoring device. It takes into account important personalized information about each user to provide proactive, real-time stress alerts.", liveUrl: "https://heartlocker3.netlify.app" },
];
