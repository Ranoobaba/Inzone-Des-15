...
const brainstormSolutions = [
  { tag: "Most Likely to Work", tagColor: "from-emerald-500 to-teal-600", tagBg: "bg-emerald-50 text-emerald-700 border border-emerald-200", title: "Inzone Ultra", description: "A full end-to-end app workflow that lets users choose apps to monitor, set pain thresholds and game types, then presents puzzle-based friction before opening stress-inducing apps. Includes leaderboards, charity donation incentives, and smart plans — making the entire experience useful and engaging." },
...
const lofiPrototypes = [
  { idea: "Most Likely to Delight", ideaColor: "bg-amber-50 text-amber-700 border-amber-200", accentColor: "from-amber-500 to-orange-500", title: "Stress Lock", question: "How might we limit the stress that our users face without directly enforcing a change of habit, but rather helping the user towards making the healthier habit themselves?", description: "A lo-fi sketch of a notification-based system that alerts users when they are spending too long on stressful apps. Users set their own preferences for how strong or gentle the incentives are, keeping the experience self-directed.", imageUrl: null },
  { idea: "Most Likely to Work", ideaColor: "bg-emerald-50 text-emerald-700 border-emerald-200", accentColor: "from-emerald-500 to-teal-500", title: "Inzone Ultra", question: "How does the full end-to-end workflow look like, and how can we make the app actually useful for the user?", description: "A lo-fi paper sketch mapping the complete user journey: choosing apps to monitor, setting pain thresholds and game types, solving puzzles before opening stress apps, leaderboard progression, charity donation incentives for hitting goals, and smart plans generated by the system.", imageUrl: "/lofi-inzone-ultra.png" },
  { idea: "Dark Horse", ideaColor: "bg-fuchsia-50 text-fuchsia-700 border-fuchsia-200", accentColor: "from-fuchsia-500 to-purple-500", title: "Stress Monitoring Band", question: "How can we work off of current stress relief devices?", description: "A lo-fi sketch of a wearable cuff that monitors stress through biometric data. The prototype shows the physical form factor, the companion app interface, and how personalized stress data is surfaced to the user in real time.", imageUrl: null },
];

const hifiPrototypes = [
  { idea: "Most Likely to Delight", ideaColor: "bg-amber-50 text-amber-700 border-amber-200", accentColor: "from-amber-500 to-orange-500", title: "Stress Lock", question: "How might we limit the stress that our users face without directly enforcing a change of habit, but rather helping the user towards making the healthier habit themselves?", description: "We create notifiers for the user so that they feel that same incentive to not stay too long on a stressful app, and make the incentive stronger or weaker with the user's preferences. The system respects user autonomy while providing gentle, customizable nudges toward healthier behavior.", liveUrl: "https://heartlocker.netlify.app" },
  { idea: "Most Likely to Work", ideaColor: "bg-emerald-50 text-emerald-700 border-emerald-200", accentColor: "from-emerald-500 to-teal-500", title: "Inzone Ultra", question: "How can we make this product attractive to our users when the overall assistance is with something very personal like someone's stress?", description: "We make the assistance indirect, embedding games within each app that users have identified as stress-inducing. The games serve as a stress reliever delivered at an optimal time — right when the user is about to enter a high-stress digital environment. The full workflow includes app selection, threshold configuration, puzzle gates, leaderboards, and charity donation incentives.", liveUrl: "https://heartlocker.netlify.app" },
  { idea: "Dark Horse", ideaColor: "bg-fuchsia-50 text-fuchsia-700 border-fuchsia-200", accentColor: "from-fuchsia-500 to-purple-500", title: "Stress Monitoring Band", question: "How can we work off of current stress relief devices?", description: "Working off the heart rate monitoring capabilities of Apple Watches and similar wearables, we designed a cuff that fits around the arm and acts as a dedicated stress monitoring device. It takes into account important personalized information about each user to provide proactive, real-time stress alerts.", liveUrl: "https://heartlocker.netlify.app" },
];
          ...
          <div className="animate-fade-in">
            ...
            <div className="space-y-8">
              ...
              <Card>
                ...
                <div className="mt-3"><ImageSlot src="/brainstorm-whiteboard.png" alt="Inzone idea board — whiteboard brainstorming session" /></div>
              </Card>
            </div>
          </div>
        )}
