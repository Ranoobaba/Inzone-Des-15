  ...
  return (
    <div className="min-h-screen bg-[#fafafa] font-sans text-zinc-900 antialiased">
      ...
      <main className={`mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16 ${active === "Overview" ? "pt-0 sm:pt-0" : ""}`} key={active}>
        ...
        {active === "Summary" && (
          <div className="animate-fade-in">
            <SectionHeading title="Summary of Project" subtitle="A complete overview of our research journey — from needfinding through prototyping and usability testing." badge="Final" />
            ...
            <div className="space-y-8">
              ...
              <Card>
                ...
                <p className="text-[15px] leading-[1.85] text-zinc-600">
                  With our combined experience in dealing with stressful apps on our phones, we found that we wanted to work within this problem space by trying to find out how we could make the process of detachment from unhealthy phone use easier. This resulted in our research of creating our own app that could help with stress management while someone uses their phone, with Rayyan handling the website design, Meshal the software design, and Aryan the hardware design and testing.
                </p>
              </Card>
              ...
              <Card>
                ...
                <p className="text-[15px] leading-[1.85] text-zinc-600">
                  The current working model for the finalized app, Heart Lock 3.0, is still in design. However, we can say that it will be a more visually cleaner version of Heart Lock 2.0, taking into account the feedback about more variety in games for stress management.
                </p>
              </Card>
